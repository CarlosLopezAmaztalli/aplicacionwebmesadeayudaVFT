    ...
    $.ajax({
        ...
        success:function(respuesta){
            ...
            Swal.fire(":)","El usuario fue agregado con exito","success");
                ...
                Swal.fire(":/","Ha sucedido un error, el usuario no se pudo agregar"+respuesta,"error");
            }
        }
    });
    return false;
        ...
        success:function(respuesta){
            ...
            if(respuesta==1){
                ...
                Swal.fire(":)","El usuario fue actualizado con exito","success");
                    ...
                    Swal.fire(":/","Ha sucedido un error, el usuario no se pudo actualizar"+respuesta,"error");
                }
        }
    });
    ...
    $.ajax({
        ...
        success:function(respuesta){
            ...
            if(respuesta==1){
                ...
                Swal.fire(":)","La contraseña fue actualizado con exito","success");
                }else{
                    Swal.fire(":/","Ha sucedido un error, la contraseña no se pudo actualizar"+respuesta,"error");
                }
        }
    });
    return false;
        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                success:function(respuesta){
                    ...
                    if(respuesta==1){
                        $('#tablaUsuariosLoad').load("usuarios/tablaUsuarios.php"); 
                        Swal.fire(":)","El usuario fue eliminado con exito","warning");
                        }else{
                            Swal.fire(":/","Ha sucedido un error, el usuario no se pudo eliminar"+respuesta,"error");
                        }
                }
            });
        }
